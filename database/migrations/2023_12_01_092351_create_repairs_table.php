...
class CreateRepairsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('repairs', function (Blueprint $table) {
            ...
            $table->foreignId('sale_voucher_id')->nullable()->constrained('sale_vouchers')->comment('item serial  is capture here');
            $table->foreignId('return_id')->nullable()->constrained('return_products');
